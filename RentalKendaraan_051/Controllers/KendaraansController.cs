...
namespace RentalKendaraan_051.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ktsd, string searchString)
        {
            ...
            var ktsdQuery = from d in _context.Kendaraan orderby d.Keteresediaan select d.Keteresediaan;
            ...
            {
                menu = menu.Where(x => x.Keteresediaan == ktsd);
            }
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Keteresediaan")] Kendaraan kendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Keteresediaan")] Kendaraan kendaraan)
        {
